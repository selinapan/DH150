...
> Venmo: Evaluation - 3
>> _Good_ - Loading sign when entering the app. The personal balance is apparent when user is confirming to pay to the recipient. Incomplete requests or payments to the user are noticeable.
>
